...
%{?el6:%global _has_asm_msr_index 0}
...
%define with_ceph 0%{!?_without_ceph:0}
...
%define with_curl_json 0%{!?_without_curl_json:0}
...
%define with_ping 0%{!?_without_ping:0}
...
%define with_tcpconns 0%{!?_without_tcpconns:0}
...
%if %{with_jobmetrics}
%define _with_jobmetrics --enable-jobmetrics 
%else
%define _with_jobmetrics --disable-jobmetrics
%endif
